...
const store = createStore({
    ...
    actions : {
        ...
        fetchItems ({ state, commit }, pageNo){
            ...
            return new Promise((resolve, reject) => {
                ...
                //const res = await axios.get(`http://openapi.tago.go.kr/openapi/service/DmstcFlightNvgInfoService/getFlightOpratInfoList?serviceKey=${FLIGHT_API_KEY}&numOfRows=10&pageNo=${pageNo}&depAirportId=${state.depAirportId}&arrAirportId=${state.arrAirportId}&depPlandTime=${depPlandTime}`)
                axios.get(url)
                    .then((res) => {
